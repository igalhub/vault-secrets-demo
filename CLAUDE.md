...
Responsibilities:
- Own and maintain docs/PRD.md
- Break the PRD into discrete tickets in docs/TICKETS.md, each with:
...
- Maintain a CHANGELOG.md entry for each accepted ticket
  *(not followed in this project — all 9 tickets completed without a CHANGELOG;
  create one if the project is reopened for new work)*
